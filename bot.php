			...
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/y_a_n_u_u",
                   'caption'=>'𓊈 YASEEN 𓊉 𓁹 التفعيل بواسطة @O7OQOO',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'➕ اضافه حسابات وهميه ➕','callback_data'=>'login'],['text'=>'➖صفحه التحكم ➖','callback_data'=>'backakil']],
                       [['text'=>"قناتي ✔ ", 'url'=>"https://t.me/O7OQOO"],['text'=>"المطور ➿ ", 'url'=>"https://t.me/y_a_n_u_u"]],
          	...
          	if($config['mode'] != null){
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>' قناتي❗','url'=>'t.me/O7OQOO'],['text'=>'المطور❔','url'=>'t.me/y_a_n_u_u']],
                      ]
                  ])
                  ]);
          		    $config['mode'] = null;
...
اضغط في الاسفل لمراسله المطور 👇",
                								...
                								'reply_markup'=>json_encode([
                								          ...
                								          'inline_keyboard'=>[
                								                   ...
                								                   [['text'=>'اضغط لمراسله المطور 🗣','url'=>'t.me/y_a_n_u_u']],
     ...
     $bot->sendMessage([
                      ...
                      'text'=>"التحكم بلبوت @O7OQOO ",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'قناتي','url'=>'t.me/AKIL828'],['text'=>'تواصل','url'=>'t.me/y_a_n_u_u']],
                           [['text'=>'اشتراك بلبوت','url'=>'t.me/y_a_n_u_u']],
